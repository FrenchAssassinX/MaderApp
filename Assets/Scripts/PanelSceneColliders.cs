...
public class PanelSceneColliders : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        topCollider.parent = panel.transform;
        bottomCollider.parent = panel.transform;
        rightCollider.parent = panel.transform;
        leftCollider.parent = panel.transform;
